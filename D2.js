...
if (num1 > 15) {
  console.log('numero 1 è più grande')
} else if (num2 > 15) {
  console.log('numero 2 è il piu grande')
}
...
if (num5 === 8 || num6 === 8) {
  console.log('ok va bene cosi, hai trovato il numero 8')
} else if (num5 + num6 === 8) {
...
let speseDiSpedizione = 10

if (totalShoppingCart > 50) {
  console.log(
    'Saldo: ' + totalShoppingCart + '(Hai diritto alla spedizione gratuita)'
  )
} else if (totalShoppingCart < 50) {
  console.log('Saldo: ' + (totalShoppingCart + speseDiSpedizione))
}
